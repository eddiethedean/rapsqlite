...
class Connection:
    ...
    def _cache_initialize(self, table_name: str) -> Coroutine[Any, Any, bool]: ...
    def _cache_get(
    ...
    def in_transaction_async(self) -> Coroutine[Any, Any, bool]: ...
    """Async method form of the transaction-state check."""
    ...
    def query_usage_dropped(self) -> int: ...
