...
class Connection:
    ...
    def savepoint(self, name: Optional[str] = None) -> "SavepointContextManager": ...
    @property
    def path(self) -> str:
    ...
    @iter_chunk_size.setter
    def iter_chunk_size(self, value: int) -> None: ...
    @property
    def idle_timeout(self) -> Optional[int]: ...
    @idle_timeout.setter
    def idle_timeout(self, value: Optional[int]) -> None: ...
...
class PreparedQuery:
    """Connection-bound reusable query object."""

    @property
    def query(self) -> str: ...
    async def execute(self, parameters: Optional[Any] = None) -> Any: ...
    async def fetch_all(self, parameters: Optional[Any] = None) -> List[Any]: ...
    async def fetch_one(self, parameters: Optional[Any] = None) -> Any: ...
    async def fetch_optional(self, parameters: Optional[Any] = None) -> Optional[Any]: ...
    async def fetch_scalar(self, parameters: Optional[Any] = None) -> Any: ...
    async def fetch_blob(self, parameters: Optional[Any] = None) -> Optional[bytes]: ...
...
class SavepointContextManager:
    """Async context manager for savepoints. Returned by Connection.savepoint()."""
