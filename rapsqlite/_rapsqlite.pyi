...
class Connection:
    ...
    def execute(self, query: str, parameters: Optional[Any] = None) -> Coroutine[Any, Any, None]: ...
    def execute_many(
        self, query: str, parameters: List[List[Any]]
    ) -> Coroutine[Any, Any, None]: ...
    def fetch_all(self, query: str, parameters: Optional[Any] = None) -> Coroutine[Any, Any, List[List[Any]]]: ...
    def fetch_one(self, query: str, parameters: Optional[Any] = None) -> Coroutine[Any, Any, List[Any]]: ...
    def fetch_optional(
